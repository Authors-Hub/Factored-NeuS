...
<img float=left height=100 width=100  src="video/hotdog/rendering.gif">
<img float=left height=100 width=100 src="video/hotdog/albedo.gif">
<img float=left height=100 width=100 src="video/hotdog/indirect light.gif">
<img float=left height=100 width=100 src="video/hotdog/light visibility.gif">
<img float=left height=100 width=100 src="video/hotdog/relighting.gif">
